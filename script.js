...
function render(array){
    ...
    th_img_link.innerText = 'Img_link'

    tr_header.append(th_id,th_name, th_age, th_rate, th_description, th_favourite, th_img_link)
    ...
    for (let elem of array){
		...
		let td_img_kota=document.createElement('img')
		

        td_img_kota.append(td_img_link)
        ...
        td_img_link.innerText = elem.img_link
		td_img_kota.src = elem.img_link
		td_img_kota.width = "100"
        td_img_kota.height = "100"
        td_img_kota.alt = "фото кота"

        tr_elem.append(td_id,td_name, td_age, td_rate, td_description, td_favourite, td_img_kota)
    }
}
